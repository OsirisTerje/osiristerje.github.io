...
I did an article on Subsystem branching ([original article on GeeksWithBlogs](http://geekswithblogs.net/terje/archive/2008/11/02/handling-subsystem-branching.aspx)) as a result of a post on the Microsoft forums regarding this.
