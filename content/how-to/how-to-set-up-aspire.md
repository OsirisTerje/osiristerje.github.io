...
![alt text](./images/check_workloads.png)
...
![alt text](./images/aspire_templates.png)

6. Install the Aspire CLI

![alt text](./images/aspire_cli.png)
