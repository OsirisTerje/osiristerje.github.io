...
layout: post
---
UPDATED March 24th 2016:   Test Data Retention is now added to TFS 2015 Update 1,  see[this post](http://hermit.no/test-data-retention-policy-added-in-tfs-update-1/) for more information.
...
<span style="color: #ff0000;">UPDATED Mar 17th 2012: </span><span style="color: #000000;">Added sql queries for TFS 11 Beta.  Changed structure after [Adam’s](http://www.adamcogan.com/) advices. Updated information. </span>
...
[Anu’s very important blog post](http://blogs.msdn.com/b/anutthara/archive/2011/10/30/gsjgd.aspx) here describes both the problem and solutions to handle it.  She describes both the Test Attachment Cleaner tool, and also some QFE/CU releases to fix some underlying bugs which prevented the tool from being fully effective.

[Brian Harry’s blog post here](http://blogs.msdn.com/b/bharry/archive/2011/10/31/tfs-databases-growing-out-of-control.aspx) describes the problem too

[This forum thread](http://social.msdn.microsoft.com/Forums/en-AU/tfsgeneral/thread/188cf534-d928-46b0-afa4-0b1192714d24) describes the problem with some solution hints.
...
<ol>
	<li>You should preferable update to CU2, otherwise you can install the QFE for [KB2608743](http://support.microsoft.com/kb/2608743) – which also contains detailed instructions on its use, [download from here](http://hotfixv4.microsoft.com/Visual%20Studio%202010/sp1/DevDiv953788/40219.350/free/438787_intl_i386_zip.exe).</li>
</ol>
</li>
</ol>
...
To find out about this you need to query your TFS database for some of the information, and use the [Test Attachment Cleaner](http://visualstudiogallery.msdn.microsoft.com/3d37ce86-05f1-4165-957c-26aaa5ea1010) (TAC) to obtain some  more detailed information.
...
[![image](/images/2015/08/GWB-Windows-Live-Writer-9d5d9927ea0a_143E6-image_thumb.png)](http://gwb.blob.core.windows.net/terje/Windows-Live-Writer/9d5d9927ea0a_143E6/image_2.png)
...
Use the script at the bottom of [Grant’s blog](http://blogs.msdn.com/b/granth/archive/2011/02/12/tfs2010-test-attachment-cleaner-and-why-you-should-be-using-it.aspx) to find the table sizes in descending size order.  Add a “use Tfs_DefaultCollection” or whatever name you have for your collection database( s) at the top of the script.

In our case we got this result:

[![image](/images/2015/08/GWB-Windows-Live-Writer-9d5d9927ea0a_143E6-image_thumb_1.png)](http://gwb.blob.core.windows.net/terje/Windows-Live-Writer/9d5d9927ea0a_143E6/image_4.png)
...
[![image](/images/2015/08/GWB-Windows-Live-Writer-9d5d9927ea0a_143E6-image_thumb_2.png)](http://gwb.blob.core.windows.net/terje/Windows-Live-Writer/9d5d9927ea0a_143E6/image_6.png)
...
[![image](/images/2015/08/GWB-Windows-Live-Writer-9d5d9927ea0a_143E6-image_thumb_3.png)](http://gwb.blob.core.windows.net/terje/Windows-Live-Writer/9d5d9927ea0a_143E6/image_8.png)
...
[![image](/images/2015/08/GWB-Windows-Live-Writer-9d5d9927ea0a_143E6-image_thumb_4.png)](http://gwb.blob.core.windows.net/terje/Windows-Live-Writer/9d5d9927ea0a_143E6/image_10.png)
